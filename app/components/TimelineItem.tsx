...
export default function TimelineItem({index, children}: TimelineItemProps) {
  return (
    <div
      className="relative flex w-1/2 odd:justify-end even:self-end even:pl-6 odd:pr-6 odd:text-right after:bg-white timeline-item transition-colors dark:after:bg-darkgrey even:after:right-auto even:after:left-4 after:absolute after:right-4 after:transform after:rotate-45 after:w-4 after:h-4 z-10"
