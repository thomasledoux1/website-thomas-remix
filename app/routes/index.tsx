...
export let meta: MetaFunction = () => {
  return {
    title: 'Thomas Ledoux | Portfolio - Home',
    description:
      'You can find projects Thomas Ledoux worked on and contact details right here',
  };
};
...
export default function Index() {
  ...
  const { blogs, stravaActivities, stravaStats } = data;
      ...
      >
        <div className="container gap-8 md:gap-0 mx-6 sm:mx-auto grid md:grid-cols-2 items-center content-center justify-items-center">
          <h1 className="text-4xl font-bold md:text-6xl flex flex-col items-center md:items-start">
            ...
            <a className="animate-title-part1" href="#portfolio">
              developer
            </a>
            <a className="animate-title-part2" href="#stats">
              cyclist
            </a>
            <a className="animate-title-part3" href="#personal">
              travel lover
            </a>
          </h1>
          <div className="w-3/4">
